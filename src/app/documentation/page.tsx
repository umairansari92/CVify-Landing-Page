...
const Documentation = () => {
  ...
  const content: Record<string, React.ReactNode> = {
    ...
    diamonds: (<><DocHeader title="Diamond Economy 💎" badge="Business" /><p className="text-slate-400 text-[15px] leading-relaxed mb-6">Post-success billing only. Never charged for failed requests.</p><CT items={[{left:"Fresh Deep Scan",right:"50 💎 (One-time)"},{left:"24h Re-scan (Same)",right:"0 💎 (FREE)"},{left:"24h Re-scan (Improved)",right:"25 💎 (50% Off)"},{left:"AI Cover Letter",right:"20 💎"},{left:"Signup Bonus",right:"100 💎 free"}]} /></>),
